...
#include "MyProjectileConfig.h"
#include "MyProjectileConfigProps.h"
...
UCLASS()
class AMyProjectileActor : public ATUActor
{
	GENERATED_BODY()
...
public:
	...
	const FMyProjectileConfigProps& GetConfigProps() const
	{
		return ConfigProps;
	}
...
private:
	...
	FMyProjectileConfigProps ConfigProps;
	...
	float Damage = MyProjectileConfig::Default::DAMAGE;
	...
	/** DamageRadius*/
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Meta=(AllowPrivateAccess=true), Category=Damage)
	float DamageRadius = MyProjectileConfig::Default::DAMAGE_RADIUS;
